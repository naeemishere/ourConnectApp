...
//followedUsername must exist in database
    ...
    let doesFollowAlreadytExist = await followsCollection.findOne({followedId: this.followedId, authorId: new ObjectID(this.authorId)})
    if (action == "create") {
      if (doesFollowAlreadytExist) {
         this.errors.push("You are already following this user!")
      }
    }
    if (action == "delete") {
        if (!doesFollowAlreadytExist) {
           this.errors.push("You cannot unfollow a user that you don't already follow!")
        }
    }
